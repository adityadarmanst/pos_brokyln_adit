...
class superAdminController extends Controller
{
  ...
  public function riwayatTransaksiSuperAdmin()
  {
    $tampilRiwayatTransaksi = DB::table('tbl_faktur') -> skip(0) -> take(100) -> orderByRaw('id DESC') -> get();
